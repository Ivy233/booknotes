...
以下内容没有来自于课本，而是来自于[这个链接](https://blog.csdn.net/bytxl/article/details/50111971)和[这个链接](https://blog.csdn.net/lilonglong1100/article/details/52914021)，对于PPP协议讲解的非常完整，但是缺陷是内容太长而很难被课本这样需要短小精悍的内容完整概括。
...
| :--: | :-----: | :-----: | :------: | :-------------: | :--: | :------: | :--: |
| 0x7f |  0xff   |  0x03   | 1/2bytes | Up to 1500bytes |  ?   | 2/4bytes | 0x7f |
